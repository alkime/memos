...
Built infrastructure for HVFLab's companies, the most notable being [**Affirm**](https://www.affirm.com/) & [**Glow**](https://glowing.com/). Created reusable IaC components to stand up clouds quickly on AWS EC2. Technologies: AWS EC2, MySQL deployed in HA mode on EC2; coroutine python (gevent) for certain services.

Gave insight on pitches heard by HVF Investments (now [**Scifi.vc**](https://scifi.vc/)).
...
Details available on request, or visit my [**LinkedIn**](https://www.linkedin.com/in/jamesmckernan/).
